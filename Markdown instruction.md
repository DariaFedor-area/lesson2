...
5. В ветке quotes внесена инфо по оформлению 
...
7. Залита ветка tables. Конфликт. не принят текст с детализацией ДЗ, но оставлена инфо по выполнению. При решении конфликта частичное удаление текста из заливаемой ветки.
